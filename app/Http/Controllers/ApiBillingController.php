...
class ApiBillingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $billingObjs = array('user_id' => $userId, 'gallery_id' => $galleryId, 'billing_email' => $billingEmail, 'billing_phone' => $billingPhone, 'billing_address' => $billingAddress, 'billing_name' => $billingName, 'comment' => $billingComment, 'total_price' => $totalPrice, 'total_price' => $totalPrice, 'status' => 'processing', 'created_at' =>  \Carbon\Carbon::now(), 'updated_at' => \Carbon\Carbon::now());
