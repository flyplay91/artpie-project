...
$(document).ready(function () {
  ...
  $('body').on('click', '.bg-overlay label', function () {
    var scrolledTop = $('#mainWrapper').position().top;
  ...
  $(document).on('click', '.btn-purchase-fragments', function () {
    ...
    var pieceCount = $(this).closest('.gallery-pieces-buy').find('.gallery-pieces-count').val();
    var userId = $(this).closest('.popup-gallery-data').data('user-id');
    $.ajax({
  ...
  galleryAjax[id] = $.ajax({
    ...
    success: function success(result) {
      ...
      $.each(result.gallery_Obj, function (key, val) {
        ...
        html += "<a href=\"/images/".concat(val.g_resized_image_large, "\" class=\"MagicZoom\" data-options=\"cssClass: mz-show-arrows; zoomPosition: inner; zoomMode:off; lazyZoom: true;\" >");
...
/******/ 	__webpack_require__.O(undefined, ["css/admin/app","css/front/app"], () => (__webpack_require__("./resources/js/front/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/admin/app","css/front/app"], () => (__webpack_require__("./resources/sass/front/app.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/admin/app","css/front/app"], () => (__webpack_require__("./resources/sass/admin/app.scss")))
