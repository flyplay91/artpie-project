...
__webpack_require__(/*! ./bootstrap */ "./resources/js/front/bootstrap.js"); // Pan Zoom plugin JS
...
jQuery.fn.extend({
  pan: function pan() {
    ...
    $("body").append(panWrapper); //Remove from set those image elements that are already shown in their natural size (they don't need zoom at all)
    ...
    finalSet.click(function (e) {
      var t = $(this);
      var big = t.attr("data-big"); //If there's no data-big attribute, use the src of the image (sometimes they are simply limited in size with CSS and you just need a zoom of that)
    ...
    $(panWrapper).mousewheel(function (wheelEvent) {
      if (wheelEvent.deltaY > 0) $(zo).click();else $(zi).click();
      panInit(wheelEvent);
